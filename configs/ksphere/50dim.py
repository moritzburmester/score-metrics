...
def get_config():
  ...
  logging.log_name = '50-sphere_exp1'
  logging.top_k = 5
  ...
  model.checkpoint_path = "logs/ksphere/50-sphere_exp1/checkpoints/best/epoch=12549--eval_loss_epoch=128.558.ckpt" #'/home/gb511/projects/manifold_dimension/ksphere/ve/checkpoints/last.ckpt'
