...
def get_config():
  ...
  logging.log_name = '1-sphere_exp6'
  logging.top_k = 5
  ...
  logging.save_svd = True #choose whether to save spectra.
  logging.svd_points = 25 #num points for spectrum estimation
  ...
  sampling.snr = 0.25 #0.15 in VE sde (you typically need to play with this term - more details in the main paper)
  ...
  #data.radii = 'unit'
  #data.n_spheres = 3
  #data.radii = [1.0, 2.0, 1.5]  # radius of each circle
  data.ambient_dim=2
  data.manifold_dim=1
  data.noise_std = 0.0
  ...
  model.checkpoint_path = "logs/ksphere/1-sphere_exp1/checkpoints/best/epoch=1120--eval_loss_epoch=5.006.ckpt"#"logs/ksphere/1-sphere_exp2/checkpoints/best/epoch=1031--eval_loss_epoch=6.385.ckpt" ##"logs/ksphere/1-sphere_exp6/checkpoints/best/epoch=786--eval_loss_epoch=6.595.ckpt"
