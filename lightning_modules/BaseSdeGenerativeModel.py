...
class BaseSdeGenerativeModel(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(
            ...
            patience=500,        # adjust based on validation eval frequency
            min_lr=1e-5,
            verbose=True
        )
        ...
        return {
            ...
            'lr_scheduler': {
                'scheduler': scheduler,
                'monitor': 'eval_loss',  # track validation loss
                'interval': 'epoch',      # can also be 'epoch'
                'frequency': 1
            }
        }
